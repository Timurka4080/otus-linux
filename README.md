...
- Далее надо запусть vm при помощи vagrant и Amsible для настройки топологоии. В конце надо запустить отдельно plaibook __restart__ для применения всех настрояк
